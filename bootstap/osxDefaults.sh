...
defaults write com.apple.screencapture location -string "${HOME}/Archive/Screenshots"
...
defaults write org.m0k.transmission IncompleteDownloadFolder -string
"${HOME}/Archive/Torrents/in_progress"
